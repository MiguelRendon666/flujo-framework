...
**NO-editables** — bloquean TODA edicion de codigo (extensiones de `flujo.json > codeExtensions`, pobladas por el stack-pack instalado) y de los archivos de control; solo permiten `.md`/`.feature`:
