...
- Search: devexpress_docs_search(technology="XAF XPO filtering", query="<your question>")
...
- **XPCollection**: - `devexpress_docs_search(technology="XAF XPO filtering", query="XPCollection criteria filter")`
